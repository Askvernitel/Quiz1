...
public class CustomerController {
    ...
    public Boolean changeCustomerStatus(@RequestBody RequestData<Integer> statusData, @PathVariable Long id)
            throws Exception {
    ...
    @GetMapping(value = "/paging/customer", produces = { "application/json" })
    public Page<GetCustomer> getCustomerPage(@RequestBody Paging paging) {
        return customerService.getCustomerPage(paging);
    }
